...
namespace Proxies\__CG__\UtilisateursBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Utilisateurs extends \UtilisateursBundle\Entity\Utilisateurs implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'UtilisateursBundle\\Entity\\Utilisateurs' . "\0" . 'comments', '' . "\0" . 'UtilisateursBundle\\Entity\\Utilisateurs' . "\0" . 'replays', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt'];
        }
    ...
    public function addReplay(\BackBundle\Entity\Replay $replay)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addReplay', [$replay]);

        return parent::addReplay($replay);
    }
    ...
    public function removeReplay(\BackBundle\Entity\Replay $replay)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeReplay', [$replay]);

        return parent::removeReplay($replay);
    }
    ...
    public function getReplays()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getReplays', []);

        return parent::getReplays();
    }
