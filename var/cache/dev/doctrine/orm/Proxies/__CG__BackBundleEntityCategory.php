...
class Category extends \BackBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackBundle\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'BackBundle\\Entity\\Category' . "\0" . 'name', '' . "\0" . 'BackBundle\\Entity\\Category' . "\0" . 'active', '' . "\0" . 'BackBundle\\Entity\\Category' . "\0" . 'created', '' . "\0" . 'BackBundle\\Entity\\Category' . "\0" . 'updated', '' . "\0" . 'BackBundle\\Entity\\Category' . "\0" . 'articles', '' . "\0" . 'BackBundle\\Entity\\Category' . "\0" . 'slug'];
        }
